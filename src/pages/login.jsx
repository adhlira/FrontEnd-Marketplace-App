  ...
  return (
    <>
      <div className="bg-blue-800 flex justify-center h-screen">
        <div className="container border mx-auto place-self-center rounded-md p-5 w-80 h-96 bg-gray-800">
          <h1 className="text-white text-center text-2xl mb-5">Welcome Back</h1>
          <form action="" className="">
            ...
            <button className="w-full p-2 border rounded-full bg-blue-800 mt-10 text-white">LOGIN</button>
            <div className="flex mt-5">
              <div className="flex-1 text-center">
                <p className="text-white text-xs">Dont have an account yet ?</p>
              </div>

              <a href="" className="text-xs mr-5 text-white hover:underline">
                Sign Up here
              </a>
            </div>
          </form>
